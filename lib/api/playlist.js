export function createPlaylistCalls(api) {
  return {
    ...
    removeItem: (playlistId, itemId) =>
      api.playlist.removeItem(playlistId, itemId),
    moveItem: (playlistId, itemId, position) =>
      api.playlist.moveItem(playlistId, itemId, position),
    importPlaylist: (playlistId, data) =>
      api.playlist.importPlaylist(playlistId, data),
  };
}

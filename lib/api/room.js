export function createRoomCalls(api) {
    return {
        ...
        updateUserRole: (slug, userId, role) => api.room.updateUserRole(slug, userId, role),
        ...
        moveInWaitlist: (slug, userId, position) => api.room.moveInWaitlist(slug, userId, position),
        removeFromWaitlist: (slug, userId) => api.room.removeFromWaitlist(slug, userId),
        ...
        getAuditLog: (slug, limit, before) => api.room.getAuditLog(slug, limit, before),
